...
function OptionsAvatar() {
    ...
    return (
        <div className={cx("optionsAvatar__container")}>
            ...
            <div className={cx("optionsAvatar__item", "optionsAvatar__upload")} onClick={handleClickSetAvatar}>
                <span>Tải ảnh lên</span>
                <input type='file' onChange={handleSetAvatar} ref={inputSetAvatarRef} style={{display: 'none'}} />
            </div>
            <div className={cx("optionsAvatar__item", "optionsAvatar__delete")} onClick={deleteAvatar}>
                <span>Gỡ ảnh hiện tại</span>
            </div>
            <div className={cx("optionsAvatar__item", "optionsAvatar__cancel")} onClick={closeModal}>
                <span>Hủy</span>
            </div>
        </div>
    );
