...
function Sidebar() {
  ...
  function checkNavigationActive() {
    const navigation__items = document.querySelectorAll(
      "." + cx("navigation__item")
    );
    ...
    function solve(event, item) {
      Array.from(navigation__items).forEach(function (navItem) {
        if (
          navItem.classList.contains(classActive) &&
          "level" in navItem.dataset &&
          "level" in item.dataset
        ) {
      ...
      if (getItemLevel(item) === 2) {
        ...
        previousActiveElements.forEach((value) => {
          ...
          if (getItemLevel(value) === 2) {
            if (value !== item) {
              if (
                value.classList.contains(cx("navigation__item-search_account"))
              )
    ...
    document.addEventListener("click", function (event) {
      ...
      navigation__items.forEach((value) => {
        ...
        if (
          !(
            event.target.classList.contains(classNavigation__itemSee_more) ||
            event.target.closest("." + classNavigation__itemSee_more)
          )
        ) {
          if (
            value.classList.contains(classNavigation__itemSee_more) &&
            value.classList.contains(classActive)
          ) {
            value.click();
          }
        }
  ...
  function handleAnimationSidebarWhenClickNavLevel2() {
    const navigation__itemSpan = document.querySelectorAll(
      "." + cx("navigation__item-span")
    );
  ...
  function handleRouterPageMessage() {
    if (!currentPath.startsWith("/message/")) navigate("/message/inbox");
    else navMessageRef.current.click();
  }
      ...
      <div className={cx("sidebar", "navigation_bar")} ref={navigation_bar}>
        ...
        <div className={cx("navigation-page", "combined")}>
          ...
          <div
            className={cx(
              "navigation__item",
              "navigation__item-search_account"
            )}
            data-level='2'
          >
            <div className={cx("navigation__item-logo")}>
          ...
          <div
            className={cx("navigation__item", "navigation__item-message")}
            data-level='1'
            onClick={handleRouterPageMessage}
            ref={navMessageRef}
          >
            <div className={cx("navigation__item-logo")}>
              <div className={cx("navigation__item-logo--no_active")}>
              ...
              <div
                className={cx("icon-amountNotification")}
                style={{
                  display: quantityMessageNotCheck === 0 ? "none" : "flex",
                }}
              >
          ...
          <div
            className={cx("navigation__item", "navigation__item-notification")}
            data-level='2'
          >
            <div className={cx("navigation__item-logo")}>
              <div className={cx("navigation__item-logo--no_active")}>
              ...
              <div
                ...
                style={{
                  display:
                    quantityPostNotificationCheck === 0 ? "none" : "flex",
                }}
              >
          ...
          <div
            className={cx("navigation__item", "navigation__item-profile")}
            data-level='1'
            onClick={handleRouterPageProfile}
            ref={navProfileRef}
          >
            <div className={cx("navigation__item-logo")}>
          ...
          {roles === "ADMIN" && (
            <div
              className={cx("navigation__item", "navigation__item-dashboard")}
              onClick={handleRouterPageDashboard}
              ref={navDashboardRef}
            >
              <div className={cx("navigation__item-logo")}>
                <div className={cx("navigation__item-logo--no_active")}>
        ...
        <div className={cx("navigation-see_more")}>
          <div
            className={cx("navigation__item", "navigation__item-see_more")}
            data-level='3'
          >
            <div className={cx("navigation__item-logo")}>
              <div className={cx("navigation__item-logo--no_active")}>
