...
import { changeIconWhenActive } from './navigationBar/changeIconWhenActive';
import Search from './pagesInSidebar/Search';
import Notification from './pagesInSidebar/Notification';
...
function Sidebar() {
    ...
    function checkNavigationActive() {
        ...
        function solve(event, item) {
            Array.from(navigation__items).forEach(function (navItem) {
                if (navItem.classList.contains(classActive) && 'level' in navItem.dataset && 'level' in item.dataset) {
        ...
        function removeActiveByLevel(previousActiveElements, item) {
            ...
            if (getItemLevel(item) === 2) {
                ...
                previousActiveElements.forEach(value => {
                    ...
                    if (getItemLevel(value) === 2) {
                        if (value !== item) {
                            if (value.classList.contains(cx('navigation__item-search_account')))
                                setSearchIsActive(false)
                            if (value.classList.contains(cx('navigation__item-notification')))
                                setNotificationIsActive(false)
                            value.classList.remove(cx('active'))
                            checkDoubleLevel2 = true
                        }
                    }
                });

                if (item.classList.contains(cx('active'))) {
                    if (item.classList.contains(cx('navigation__item-search_account')))
                        setSearchIsActive(false)
                    if (item.classList.contains(cx('navigation__item-notification')))
                        setNotificationIsActive(false)
                ...
                handleAnimationSidebarWhenClickNavLevel2()
                if (checkDoubleLevel2) {
                    handleAnimationSidebarWhenClickNavLevel2()
                }
            }
            if (getItemLevel(item) === 3) {
                previousActiveElements.forEach(value => {
                    ...
                    if (getItemLevel(value) === 3) {
                        if (value !== item) {
                            if (value.classList.contains(cx('navigation__item-see_more')))
    ...
    function handleAnimationSidebarWhenClickNavLevel2() {
            ...
            navigation_bar.current.classList.toggle(cx('active'));
            ...
            if (window.innerWidth > 1263) {
                if (navigation_bar.current.classList.contains(cx('active'))) {
                    navigation_bar.current.classList.remove(cx('animationDisappearSideBar'));
                    navigation_bar.current.classList.add(cx('animationAppearSideBar'));
                }
                else {
                    navigation_bar.current.classList.remove(cx('animationAppearSideBar'));
                    navigation_bar.current.classList.add(cx('animationDisappearSideBar'));
                }
            }
    }
    ...
    return (
        <React.Fragment>
            <Search searchIsActive={searchIsActive} />
            <Notification notificationIsActive={notificationIsActive} />
            <div className={cx("sidebar", "navigation_bar")} ref={navigation_bar}>
                <div className={cx("logo-web")}>
                    <div className={cx("logo-web-pc")}>
                        <svg aria-label="Instagram" className={cx("x1lliihq x1n2onr6 x5n08af")} fill="currentColor" height="29"
                    ...
                    <div className={cx("logo-web-tablet")}>
                        <svg aria-label="Instagram" className={cx("x1lliihq x1n2onr6 x5n08af")} fill="currentColor" height="24"
                ...
                <div className={cx("navigation-page", "combined")}>
                    ...
                    <div className={cx("navigation__item", "navigation__item-search_account")} data-level="2">
                        <div className={cx("navigation__item-logo")}>
                            <div className={cx("navigation__item-logo--no_active")}>
                                <svg aria-label="Tìm kiếm" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                                    fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    ...
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="16.511" x2="22" y1="16.511"
                                        y2="22"></line>
                                </svg>
                            </div>
                            <div className={cx("navigation__item-logo--active")}>
                                <svg aria-label="Tìm kiếm" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                                    ...
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="3" x1="16.511" x2="21.643" y1="16.511"
                                        y2="21.643"></line>
                                </svg>
                            </div>
                        </div>
                            ...
                            <div className={cx("navigation__item-logo--no_active")}>
                                <svg aria-label="Messenger" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                                    ...
                                    <path
                                        ...
                                        fill="none" stroke="currentColor" strokeMiterlimit="10" strokeWidth="1.739">
                                    </path>
                                    <path
                    ...
                    <div className={cx("navigation__item", "navigation__item-notification")} data-level="2">
                        <div className={cx("navigation__item-logo")}>
                            <div className={cx("navigation__item-logo--no_active")}>
                                <svg aria-label="Thông báo" className={cx("x1lliihq x1n2onr6")} color="rgb(245, 245, 245)"
                                    fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <div className={cx("icon-amountNotification")} style={{display: quantityPostNotificationCheck === 0 ? 'none' : 'flex'}}>
                                <span>{quantityPostNotificationCheck}</span>
                            </div>
                        </div>
                        <span className={cx("navigation__item-span")}>Thông báo</span>
                    </div>
                    <div className={cx("navigation__item", "navigation__item-create_content")} onClick={handleOpenCreateContent}>
                        <div className={cx("navigation__item-logo")}>
                            <div className={cx("navigation__item-logo--no_active")}>
                                <svg aria-label="Bài viết mới" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                                    ...
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="6.545" x2="17.455" y1="12.001"
                                        y2="12.001"></line>
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="12.003" x2="12.003" y1="6.545"
                                        y2="17.455"></line>
                                </svg>
                            </div>
                            <div className={cx("navigation__item-logo--active")}>
                        ...
                        <span className={cx("navigation__item-span")}>Tạo</span>
                    </div>
                ...
                <div className={cx("navigation-see_more")}>
                    <div className={cx("navigation__item", "navigation__item-see_more")} data-level="3">
                        <div className={cx("navigation__item-logo")}>
                            <div className={cx("navigation__item-logo--no_active")}>
                                <svg aria-label="Cài đặt" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                                    fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="4" y2="4"></line>
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="12" y2="12"></line>
                                    <line fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="20" y2="20"></line>
                                </svg>
                            </div>
                            <div className={cx("navigation__item-logo--active")}>
                                <svg aria-label="Cài đặt" className={cx("_ab6-")} color="rgb(245, 245, 245)"
                        ...
                        <span className={cx("navigation__item-span")}>Xem thêm</span>
                    </div>
                    <SeeMoreInSideBar seeMoreInSidebar={seeMoreInSidebar} />
                </div>
            </div>
        </React.Fragment>
    )
