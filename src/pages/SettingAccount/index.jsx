  ...
  return (
    <div className={cx("setting_account__background")}>
      <div className={cx("setting_account__background__sidebar")}>
        ...
        <div
          className={cx(
            "setting_account__background__sidebar__container_group"
          )}
        >
          <div className={cx("setting_account__background__sidebar__group")}>
            <div
              className={cx(
                "setting_account__background__sidebar__group_title"
              )}
            >
            ...
            <div
              className={cx(
                "setting_account__background__sidebar__list_group_item"
              )}
            >
              <div
                className={cx(
                  "setting_account__background__sidebar__group_item",
                  tabActiveCurrent === "edit" ? "active" : ""
                )}
                onClick={() => handleTabActive("edit")}
              >
                <div
                  className={cx(
                    "setting_account__background__sidebar__group_item__icon"
                  )}
                >
                  <svg
                    aria-label=''
                ...
                <div
                  className={cx(
                    "setting_account__background__sidebar__group_item__text"
                  )}
                >
          ...
          <div className={cx("setting_account__background__sidebar__group")}>
            ...
            >
              <div
                className={cx(
                  "setting_account__background__sidebar__group_item",
                  tabActiveCurrent === "password" ? "active" : ""
                )}
