...
function EditAccount() {
  ...
  function handleOnChangeDescription(e) {
    edit_account__description__text_area__current_numberRef.current.innerText =
  ...
  function handleAppearOptionsGender() {
    if (
      edit_account__gender__input_options__list_radioRef.current.style
        .display === "none"
    )
      edit_account__gender__input_options__list_radioRef.current.style.display =
        "block";
    else
      edit_account__gender__input_options__list_radioRef.current.style.display =
        "none";
      ...
      <div className={cx("edit_account__container")}>
        ...
        <form action='' method='POST' className={cx("form")} id='form-1'>
          <div className={cx("edit_account__set_avatar")}>
            <div
              className={cx("edit_account__set_avatar__avatar_and_name_and_id")}
            >
              ...
              <div className={cx("edit_account__set_avatar__name_and_id")}>
                <span className={cx("edit_account__set_avatar__name")}>
                  {idUser}
                </span>
                <span className={cx("edit_account__set_avatar__id")}>
                  {nameUser}
                </span>
              </div>
            </div>
            <div
              className={cx("edit_account__set_avatar__set_avatar_button")}
              onClick={handleOpenOptionsAvatar}
            >
              Đổi ảnh
            </div>
          </div>
          ...
          <div className={cx("edit_account__description")}>
            ...
            <div
              className={cx(
                "edit_account__description__text_area",
                "form-group"
              )}
            >
              <textarea
              ...
              <div
                className={cx(
                  "edit_account__description__text_area__limit_text"
                )}
              >
                <span
                  className={cx(
                    "edit_account__description__text_area__current_number"
                  )}
                  ref={edit_account__description__text_area__current_numberRef}
                >
                  {descriptionUser === null ? 0 : descriptionUser.length}
                </span>
                <span
                  className={cx("edit_account__description__text_area__slash")}
                >
                  /
                </span>
                <span
                  className={cx(
                    "edit_account__description__text_area__limit_number"
                  )}
                >
                  150
                </span>
          ...
          <div className={cx("edit_account__gender")}>
            ...
            <div
              className={cx("edit_account__gender__input_options")}
              onClick={handleAppearOptionsGender}
            >
              <div
                className={cx(
                  "edit_account__gender__input_options__value_selected"
                )}
              >
                <span>
              ...
              <div
                className={cx(
                  "edit_account__gender__input_options__icon_select"
                )}
              >
                <svg
              ...
              <div
                className={cx(
                  "form-group",
                  "edit_account__gender__input_options__list_radio"
                )}
                ref={edit_account__gender__input_options__list_radioRef}
              >
                <div
                  className={cx(
                    "edit_account__gender__input_options__radio_item"
                  )}
                >
                  <span>Nam</span>
                  <input
                    ...
                    type='radio'
                    value='true'
                    checked={genderUserCopy === true}
                    onChange={() => handleCheckedGender(true)}
                    className={cx("form-control")}
                  />
                </div>
                <div
                ...
                >
                  ...
                  <input
                    ...
                    type='radio'
                    value='false'
                    checked={genderUserCopy === false}
                    onChange={() => handleCheckedGender(false)}
                    className={cx("form-control")}
                  />
                </div>
                <div
                ...
                >
                  ...
                  <input
                    ...
                    type='radio'
                    value='null'
                    checked={genderUserCopy === null}
                    onChange={() => handleCheckedGender(null)}
                    className={cx("form-control")}
                  />
                </div>
              </div>
            ...
            <div className={cx("edit_account__gender__description")}>
              <span>
                Thông tin này sẽ không xuất hiện trên trang cá nhân công khai
                của bạn
              </span>
            </div>
          </div>
