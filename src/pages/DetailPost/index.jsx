...
function DetailPost({
  ...
  const getPostById = () => {
    http.get(`api/posts/${idPost}`).then((res) => {
  ...
  const getCheckUserLike = () => {
    http
      .get(`api/user_like_post/check_like/${idUser}/${idPost}`)
      .then((res) => {
  ...
  const handleUnLikePost = () => {
    http.del(`api/user_like_post/${idUser}/${idPost}`).then((res) => {
      http
        .del(
          `api/post_notifications/by_action_like/LIKE/${idPost}/${idUser}/${
            idUserOther === undefined ? idUser : idUserOther
          }`
        )
        .then((res) => {});
  ...
  const getAllUserCommentPostByPost = () => {
    http.get(`api/user_comment_post/by_post/${idPost}`).then((res) => {
      console.log(res);
      ...
      <div className={cx("detail_post__engagement")}>
        <div className={cx("detail_post__engagement__header")}>
          <div className={cx("detail_post__engagement__avatar_and_name")}>
            ...
            >
              <img
                src={avatar === "" || avatar === null ? defaultAvatar : avatar}
                alt=''
              />
            </div>
            <div
        ...
        <div className={cx("detail_post__engagement__list_comment")}>
          ...
          <div className={cx("detail_post__engagement__comment_container")}>
            ...
            <div className={cx("detail_post__engagement__content_comment")}>
              ...
              >
                <span
                  className={cx("detail_post__engagement__time_create_comment")}
                >
