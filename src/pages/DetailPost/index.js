        ...
        <div className={cx("container_detail_post")}>
            ...
            <div className={cx("detail_post__engagement")}>
                ...
                <div className={cx("detail_post__engagement__button_engagement")}>
                    <div className={cx("detail_post__engagement__like")} style={{display: statusLike === true ? 'none' : 'flex'}} onClick={handleStatusLike}>
                    ...
                    <div className={cx("detail_post__engagement__un_like")} style={{display: statusLike === true ? 'flex' : 'none'}} onClick={handleStatusLike}>
