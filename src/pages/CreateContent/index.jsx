...
function CreateContent() {
  ...
  const handleClickSetRatioIcon = () => {
    crop_image__image__set_ratio__selectRef.current.classList.toggle(
      cx("active")
    );
  };
  ...
  const handleConfirmEdit = () => {
    if (typeMedia === "image") setIsConfirmCrop(true);
  };
  ...
  return (
    <>
      <div
        className={cx("modal__create_content", "active")}
        ref={modal__create_contentRef}
      >
        ...
        <div className={cx("modal__create_content-body")}>
          <div className={cx("modal__create_content-body__svg")}>
            ...
            >
              <title>
                Biểu tượng thể hiện file phương tiện, chẳng hạn như hình ảnh
                hoặc video
              </title>
              <path
          ...
          <div className={cx("modal__create_content-body__button_choose_file")}>
            <button onClick={handleClickSelectMedia}>
      ...
      <div className={cx("crop_image")} ref={crop_imageRef}>
        ...
        <div className={cx("crop_image__image")}>
          ...
          <div className={cx("crop_image__image__set_ratio")}>
            <div
              className={cx("crop_image__image__set_ratio__select")}
              ref={crop_image__image__set_ratio__selectRef}
            >
              <div
                className={cx("crop_image__image__set_ratio__select__item")}
                onClick={() => handleSelectRatio(1 / 1)}
              >
                <div
                  className={cx(
                    "crop_image__image__set_ratio__select__item__text"
                  )}
                >
                  <span>1:1</span>
                </div>
                <div
                  className={cx(
                    "crop_image__image__set_ratio__select__item__icon"
                  )}
                >
                  <svg
                    ...
                    width='24'
                  >
                    <title>Biểu tượng cắt theo khung hình vuông</title>
              ...
              >
                ...
                >
                  <svg
                    ...
                    width='24'
                  >
                    <title>Biểu tượng cắt theo khung hình dọc</title>
              ...
              >
                ...
                >
                  <svg
                    ...
                    width='24'
                  >
                    <title>Biểu tượng cắt theo khung hình ngang</title>
            ...
            <div
              className={cx("crop_image__image__set_ratio__icon")}
              onClick={handleClickSetRatioIcon}
            >
              <svg
      ...
      <div className={cx("confirm_post")} ref={confirm_postRef}>
        <div className={cx("confirm_post__header")}>
          ...
          <div
            className={cx("confirm_post__submit")}
        ...
        <div className={cx("confirm_post__body")}>
          ...
          <div className={cx("confirm_post__info_post")}>
            ...
            <div className={cx("confirm_post__caption")}>
              ...
              <div
                className={cx(
                  "confirm_post__caption__emoji_and_limit_textarea"
                )}
              >
                <div
                  className={cx("confirm_post__caption__emoji")}
                  style={{ display: "none" }}
                >
                  <svg
                ...
                <div className={cx("confirm_post__caption__limit_textarea")}>
                  <span>
                    {valueTextarea.length ? valueTextarea.length : 0}/255
                  </span>
                </div>
              </div>
            </div>
