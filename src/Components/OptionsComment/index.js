...
function OptionsComment({ idUser, idUserOther, idCommentPost, idPost, getAllUserCommentPostByPost }) {
    ...
    const handleDeleteComment = async () => {
        await http.del(`api/user_comment_post/${idUser}/${idCommentPost}/${idPost}`)
        await http.del(`api/post_notifications/by_action_comment/COMMENT/${idPost}/${idUser}/${idUserOther === undefined ? idUser : idUserOther}/${idCommentPost}`)
