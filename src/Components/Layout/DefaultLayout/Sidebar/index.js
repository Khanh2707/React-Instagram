    ...
    return (
        ...
        <div className={cx("sidebar", "navigation_bar")}>
            ...
            <div className={cx("navigation-page", "combined")}>
                <div className={cx("navigation__item", "navigation__item-home")} data-level="1">
                ...
                <div className={cx("navigation__item", "navigation__item-message", "active")} data-level="1">
                    <div className={cx("navigation__item-logo")}>
                        <div className={cx("navigation__item-logo--no_active")}>
                ...
                <div className={cx("navigation__item", "navigation__item-create_content")}>
                    <div className={cx("navigation__item-logo")}>
                        <div className={cx("navigation__item-logo--no_active")}>
                ...
                <div className={cx("navigation__item", "navigation__item-profile")} data-level="1">
                    <div className={cx("navigation__item-logo")}>
