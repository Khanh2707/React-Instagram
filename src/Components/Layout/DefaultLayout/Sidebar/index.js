...
import { checkNavigationActive } from './navigation-bar/checkNavigationActive';
...
function Sidebar() {
    ...
    return (
        ...
        <div className={cx("page-notification")}>
        ...
        <div className={cx("sidebar", "navigation_bar")}>
            ...
            <div className={cx("navigation-page", "combined")}>
                ...
                <div className={cx("navigation__item", "navigation__item-search_account", { 'active': isActive })} data-level="2" onClick={toggleClass}>
                    <div className={cx("navigation__item-logo")}>
                        <div className={cx("navigation__item-logo--no_active")}>
                ...
                <div className={cx("navigation__item", "navigation__item-message")} data-level="1">
                    <div className={cx("navigation__item-logo")}>
                        <div className={cx("navigation__item-logo--no_active")}>
                ...
                <div className={cx("navigation__item", "navigation__item-profile", "active")} data-level="1">
                    <div className={cx("navigation__item-logo")}>
            ...
            <div className={cx("navigation-see_more")}>
                <div className={cx("navigation__item", "navigation__item-see_more")} data-level="4">
                    <div className={cx("navigation__item-logo")}>
                        <div className={cx("navigation__item-logo--no_active")}>
                ...
                <div className={cx("page-see_more")}>
                    <ul>
                        <li>
